...
def main():
    parser = argparse.ArgumentParser(
        description="Render canonical gateway JSON into native Data Group and iFile artifacts."
    )
    parser.add_argument(
        "--canonical",
    ...
    parser.add_argument(
        ...
        help="Path to the rendered native artifacts JSON file.",
    )
    ...
    artifacts = build_native_artifacts(config, canonical_path.name)
    ...
    write_local_native_files(config, artifacts, snapshot, canonical_path.parent)
    print(output_path)
